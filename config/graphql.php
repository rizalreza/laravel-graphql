...
return [
     ...
     */
     ...
     'schemas' => [
          'default' => [
              'query' => [
                  'karyawan' => App\GraphQL\Query\KaryawanQuery::class,
              ],
               'mutation' => [
                    'createKaryawan' => App\GraphQL\Mutation\CreateKaryawanMutation::class,
                    'updateKaryawan' => App\GraphQL\Mutation\UpdateKaryawanMutation::class,
     ...
     */
      'types' =>[
         'karyawan' => 'App\GraphQL\Type\KaryawanType'
      ],
    /*
